  ...
  return (
    <div className="max-w-6xl mx-auto flex lg:flex-row flex-col gap-8 lg:mt-40 mt-14 ">
      ...
      <div className="max-w-2xl space-y-4 lg:p-0 p-2">  
        ...
        <p className="font-thin dark:text-[#737373] lg:text-justify text-center ">I'm Muhammad Khalid Zarar, a documentary video editor with over two and a half years of continuous experience in the field. My editing workflow utilizes industry-standard tools such as <span className="font-semibold underline">Premiere Pro,</span> <span className="font-semibold underline">After Effects,</span> and <span className="font-semibold underline">Photoshop</span>, along with the latest <span className="font-semibold underline">AI-powered editing software.</span> I specialize in crafting compelling documentaries through the use of motion graphics, special effects, and sound design. If you're looking for exceptional video editing that elevates your project, feel free to get in touch!</p>
      </div>
