...
export default function ContactInfo() {
  return (
    ...
    <FontAwesomeIcon icon={faFacebook} className='size-6 text-[#737373] border-2 rounded-full p-2  hover:border-primary' />
    <p className="text-sm font-semibold text-[#737373]">Facebook</p>
    </div> 
    <div className="flex gap-2 items-center">
    <FontAwesomeIcon icon={faTwitter} className='size-6 text-[#737373] border-2 rounded-full p-2  hover:border-primary' />
